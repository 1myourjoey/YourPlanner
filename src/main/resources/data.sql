...
VALUES (1, 'Title', '2024-06-06', '2024-06-07', 'Place A', 'Place B', 'Do something');

INSERT INTO Save (user_no, save_title, first_date, end_date, first_place, end_place, todo)
VALUES (1, 'Title', '2024-06-06', '2024-06-07', '파주', '강원도', '아침식사');

INSERT INTO Save (user_no, save_title, first_date, end_date, first_place, end_place, todo)
VALUES (1, '강원도로 여행', '2024-06-06', '2024-06-07', '일산', '강원도', '할일');

INSERT INTO Save (user_no, save_title, first_date, end_date, first_place, end_place, todo)
VALUES (2, 'Title', '2024-06-06', '2024-06-07', '파주', '강원도', '아침식사');