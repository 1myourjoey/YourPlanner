...
// 초기 로딩 시 데이터를 가져오는 함수
    const fetchInitialData = async () => {
        try {
            ...
            const response = await fetch(`http://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=5V%2BytDDcz11Mfxc3tREUmoX6wOvDmA3oIaBkQfhB%2Bo%2B4vBWem3h6eQhKVvJuiJvpVonGtnuRqU6A83YSSBAh8A%3D%3D&pageNo=1&numOfRows=10&MobileApp=AppTest&MobileOS=ETC&arrange=A&areaCode=${areaCode}&contentTypeId=39`);
            if (!response.ok) {
                ...
                const response = await axios.get(
                    'http://apis.data.go.kr/B551011/KorService1/areaBasedList1', {
                        params: {
                            ...
                            MobileOS: 'ETC',
                            MobileApp: 'TestApp',
                            serviceKey: '5V%2BytDDcz11Mfxc3tREUmoX6wOvDmA3oIaBkQfhB%2Bo%2B4vBWem3h6eQhKVvJuiJvpVonGtnuRqU6A83YSSBAh8A%3D%3D',
                            _type: 'json',
                            listYN: 'Y',
                            arrange: 'A',
                            contentTypeId: '39',
